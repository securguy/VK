...
Таблица 2 – Распределение слов по категориям в сообществе “Здоровье ВКонтакте”
...
Распределим топ 100 самых распространенных слов по категориям и найдем суммарную частоту использования слов в каждой категории (таблица 4).

Таблица 4 – Распределение слов по категориям в сообществе “Секреты здоровья”
...
Распределим топ 100 самых распространенных слов по категориям и найдем суммарную частоту использования слов в каждой категории (таблица 5).

Таблица 5 – Распределение слов по категориям в сообществе “Секреты здоровья”
...
## Анализ целевой аудитории по полу и возрасту
...
Таблица 6 – ЦА сообщества “Здоровье ВКонтакте”
...
### Сообщество “Секреты здоровья”
Анализ ЦА данного сообщества показал, что количество мужчин слегка превышает количество женщин, а самые многочисленная возрастная группа –средний возраст (таблица 7).

Таблица 7 – ЦА сообщества “Секреты здоровья”
...
### Сообщество “Вегетарианцы и веганы”
Анализ ЦА данного сообщества показал, что количество женщин слегка превышает количество мужчин, а самые многочисленная возрастная группа –молодежь (таблица 8).

Таблица 8 – ЦА сообщества “Секреты здоровья”
...
Таблица 9 – 3 самых популярных постов сообщества “Здоровье ВКонтакте”
...
В таблице 10 приведена информация о 3 самых популярных постах сообщества.

Таблица 10 – 3 самых популярных поста сообщества “Секреты здоровья”
...
В таблице 11 приведена информация о 3 самых популярных постах сообщества.

Таблица 11– 3 самых популярных поста сообщества “Секреты здоровья”
